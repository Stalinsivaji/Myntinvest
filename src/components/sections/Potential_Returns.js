...
class Potential_Returns extends React.Component {
    constructor() {
    super();
    this.state = {
      input: {},
  ...
  handleSubmit(event) {
    ...
    if(this.validate()){
        ...
        alert('Potential Returns Form is submitted');
    }
  }
  ...
  validate(){
      ...
      if (!input["header10"]) {
        isValid = false;
        errors["header10"] = "Enter Your header/title here.";
      }
  
      if (typeof input["header10"] !== "undefined") {
        const re = /^\S*$/;
        if(input["header10"].length < 4 || !re.test(input["header10"])){
            isValid = false;
            errors["header10"] = "Enter Your header/title here.";
        }
      }
        ...
        <div className="row" >
              ...
              <div>
               ...
               <div className='row'> 
                   ...
                   <div className='col-md-1'> <a href='/Potential_Returns'><Image   src={require('./../../assets/images/p10.webp')}alt="Features tile icon 01"  width={50} height={50}  /><p style={{color:"#2ECC71",fontSize:13}}>Potential Returns</p></a> </div>
                </div>
                <hr/>

                <br/>
                <div className='row'>
                    <div className='col-md-6'><strong style={{fontSize:25}}>Potential Returns</strong></div>
              ...
              <form>
                <div className="row">
                  ...
                  <div className="col-md-4">
                       <input
                              name="header10"
                              value={this.state.input.header10}
                      ...
                      <div className="text-danger" style={{fontSize:15}}>{this.state.errors.header10}</div>
               ...
               <div className="row" >
                ...
                <br/>
                <Button tag="a" color="secondary" className='text-white' style={{backgroundColor:"#2ECC71",borderRadius:8,width:160}} wideMobile href="/Startup_Dashboard">
                Next
                  </Button>
...
export default Potential_Returns;
