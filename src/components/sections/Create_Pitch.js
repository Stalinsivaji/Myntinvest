    ...
    <body>
        ...
        <div className="row" >
              ...
              <div>
               ...
               <br/>
               <div className='row'> 
                   <div className='col-md-1'> <a href='/Create_Pitch'><Image   src={require('./../../assets/images/p1.png')}alt="Features tile icon 01"  width={50} height={50} borderRadius={50} /><p style={{fontSize:13,color:"#2ECC71"}}>Problem</p></a> </div>
                ...
                <br/>
                <div className='row'>
                    <div className='col-md-6'><strong style={{fontSize:25}}>Problem</strong></div>
