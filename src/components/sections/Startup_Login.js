...
const Startup_Login= ({
    ...
    return(
            ...
            <div className='row' style={{paddingLeft:50,marginTop:100}}> 
            ...
            <ButtonGroup style={{paddingLeft:70}}>
                  <Button tag="a"  color="primary" style={{borderRadius:8,color:"white",width:500}} wideMobile href="/Startup_Dashboard">
                    Login
                    </Button>
                </ButtonGroup>
