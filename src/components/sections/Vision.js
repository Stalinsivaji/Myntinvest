...
class Vision extends React.Component {
  ...
  handleSubmit(event) {
    ...
    if(this.validate()){
        ...
        alert('Vision Form is submitted');
    }
  }
  ...
  validate(){
      ...
      if (!input["header9"]) {
        isValid = false;
        errors["header9"] = "Enter Your header/title here.";
      }
  
      if (typeof input["header9"] !== "undefined") {
        const re = /^\S*$/;
        if(input["header9"].length < 4 || !re.test(input["header9"])){
            isValid = false;
            errors["header9"] = "Enter Your header/title here.";
        }
      }
        ...
        <div className="row" >
              ...
              <div>
               ...
               <div className='row'> 
                   ...
                   <div className='col-md-1'> <a href='/Usage'><Image   src={require('./../../assets/images/p8.jpg')}alt="Features tile icon 01"  width={50} height={50}  /><p style={{fontSize:13}}>Usage of Funds</p></a> </div>
                   <div className='col-md-1'> <a href='/Vision'><Image   src={require('./../../assets/images/900.png')}alt="Features tile icon 01"  width={50} height={50}  /><p style={{color:"#2ECC71",fontSize:13}}>Vision</p></a> </div>
                   <div className='col-md-1'> <a href='/Potential_Returns'><Image   src={require('./../../assets/images/p10.webp')}alt="Features tile icon 01"  width={50} height={50}  /><p style={{fontSize:13}}>Potential Returns</p></a> </div>
                </div>
                <hr/>

                <br/>
                <div className='row'>
                    <div className='col-md-6'><strong style={{fontSize:25}}>Vision</strong></div>
              ...
              <form>
                <div className="row">
                  ...
                  <div className="col-md-4">
                      <input 
                            name="header9"
                            value={this.state.input.header9}
                      ...
                      <div className="text-danger" style={{fontSize:15}}>{this.state.errors.header9}</div>
               ...
               <div className="row" >
                ...
                <br/>
                <Button tag="a" color="secondary" className='text-white' style={{backgroundColor:"#2ECC71",borderRadius:8,width:160}} wideMobile href="/Potential_Returns">
                Next
                  </Button>
