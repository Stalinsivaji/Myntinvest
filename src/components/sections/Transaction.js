...
class Transaction extends React.Component {
  ...
  handleSubmit(event) {
    ...
    if(this.validate()){
        ...
        alert('Transaction Form is submitted');
    }
  }
  ...
  validate(){
      ...
      if (!input["header4"]) {
        isValid = false;
        errors["header4"] = "Enter Your header/title here.";
      }
  
      if (typeof input["header4"] !== "undefined") {
        const re = /^\S*$/;
        if(input["header4"].length < 4 || !re.test(input["header4"])){
            isValid = false;
            errors["header4"] = "Enter Your header/title here.";
        }
      }
        ...
        <div className="row" >
              ...
              <div>
               ...
               <div className='row'> 
                   ...
                   <div className='col-md-1'> <a href='/Transaction'><Image   src={require('./../../assets/images/p4.png')}alt="Features tile icon 01"  width={50} height={50}  /><p style={{fontSize:13,color:"#2ECC71"}} >Transaction</p></a> </div> 
                ...
                <br/>
                <div className='row'>
                    <div className='col-md-6'><strong style={{fontSize:25}}>Transaction</strong></div>
              ...
              <form>
                <div className="row">
                  ...
                  <div className="col-md-4">
                     <input 
                               name="header4"                     
                               value={this.state.input.header4}
                      ...
                      <div className="text-danger" style={{fontSize:15}}>{this.state.errors.header4}</div>
               ...
               <div className="row" >
                ...
                <br/>
                <Button tag="a" color="secondary" className='text-white' style={{backgroundColor:"#2ECC71",borderRadius:8,width:160}} wideMobile href="/Business_Model">
                Next
                  </Button>
