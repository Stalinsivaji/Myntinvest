        ...
        <div className="row" >
              ...
              <div>
               ...
               <div className='row'> 
                   ...
                   <div className='col-md-1'> <a href='/Solution'><Image   src={require('./../../assets/images/p002.png')}alt="Features tile icon 01"  width={50} height={50} /><p style={{fontSize:13,color:"#2ECC71"}}>Solution</p></a> </div>
                ...
                <br/>
                <div className='row'>
                    <div className='col-md-6'><strong style={{fontSize:25}}>Solution</strong></div>
              ...
              <div className="row">
               ...
               <div className="row" >
                ...
                <br/>
                <Button tag="a" color="secondary" className='text-white' style={{backgroundColor:"#2ECC71",borderRadius:8,width:160}} wideMobile href="/Product">
                Next
                  </Button>
