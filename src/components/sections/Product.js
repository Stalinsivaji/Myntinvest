...
class Product extends React.Component {
  ...
  handleSubmit(event) {
    ...
    if(this.validate()){
        ...
        alert('Product Form is submitted');
    }
  }
  ...
  validate(){
      ...
      if (!input["header3"]) {
        isValid = false;
        errors["header3"] = "Enter Your header/title here.";
      }
  
      if (typeof input["header3"] !== "undefined") {
        const re = /^\S*$/;
        if(input["header3"].length < 4 || !re.test(input["header3"])){
            isValid = false;
            errors["header3"] = "Enter Your header/title here.";
        }
      }
    ...
    <div className="row" >
          ...
          <div>
           ...
           <div className='row'> 
               ...
               <div className='col-md-1'> <a href='/Product'><Image   src={require('./../../assets/images/p003.png')}alt="Features tile icon 01"  width={50} height={50} /><p style={{fontSize:13,color:"#2ECC71"}}>Product</p></a> </div>
            ...
            <br/>
            <div className='row'>
                <div className='col-md-6'><strong style={{fontSize:25}}>Product</strong></div>
          ...
          <form>
            <div className="row">
              ...
              <div className="col-md-4">
                  <input 
                           name="header3"
                           type="text"
                           value={this.state.input.header3}
                  ...
                  <div className="text-danger" style={{fontSize:15}}>{this.state.errors.header3}</div>
           ...
           <div className="row" >
            ...
            <br/>
            <Button tag="a" color="secondary" className='text-white' style={{backgroundColor:"#2ECC71",borderRadius:8,width:160}} wideMobile href="/Transaction">
            Next
              </Button>
