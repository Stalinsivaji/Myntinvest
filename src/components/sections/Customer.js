...
validate(){
    ...
    if (!input["header7"]) {
      isValid = false;
      errors["header7"] = "Enter Your header/title here.";
    }

    if (typeof input["header7"] !== "undefined") {
      const re = /^\S*$/;
      if(input["header7"].length < 4 || !re.test(input["header7"])){
          isValid = false;
          errors["header7"] = "Enter Your header/title here.";
      }
    }
    ...
    <div className="row" >
          ...
          <div>
           ...
           <div className='row'> 
                   ...
                   <div className='col-md-1'> <a href='/Customer'><Image   src={require('./../../assets/images/p7.jpg')}alt="Features tile icon 01"  width={50} height={50}  /><p style={{color:"#2ECC71",fontSize:13}}>Customers</p></a> </div>
            ...
            <br/>
            <div className='row'>
                <div className='col-md-6'><strong style={{fontSize:25}}>Customer</strong></div>
          ...
          <form>
            <div className="row">
              ...
              <div className="col-md-4">
                      <input 
                             name="header7"
                             value={this.state.input.header7}
                  ...
                  <div className="text-danger" style={{fontSize:15}}>{this.state.errors.header7}</div>
           ...
           <div className="row" >
            ...
            <br/>
            <Button tag="a" color="secondary" className='text-white' style={{backgroundColor:"#2ECC71",borderRadius:8,width:160}} wideMobile href="/Usage">
            Next
              </Button>
