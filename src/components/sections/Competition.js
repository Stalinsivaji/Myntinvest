...
class Competition extends React.Component {
  ...
  validate(){
      ...
      if (!input["header6"]) {
        isValid = false;
        errors["header6"] = "Enter Your header/title here.";
      }
  
      if (typeof input["header6"] !== "undefined") {
        const re = /^\S*$/;
        if(input["header6"].length < 4 || !re.test(input["header6"])){
            isValid = false;
            errors["header6"] = "Enter Your header/title here.";
        }
      }
        ...
        <div className="row" >
              ...
              <div>
               ...
               <div className='row'> 
                   ...
                   <div className='col-md-1'> <a href='/Competition'><Image   src={require('./../../assets/images/p6.png')}alt="Features tile icon 01"  width={50} height={50}  /><p style={{color:"#2ECC71",fontSize:13}}>Competition</p></a> </div>
                ...
                <br/>
                <div className='row'>
                    <div className='col-md-6'><strong style={{fontSize:25}}>Competition</strong></div>
              ...
              <form>
                <div className="row">
                  ...
                  <div className="col-md-4">
                           <input 
                                 name="header6"
                                 value={this.state.input.header6}
                      ...
                      <div className="text-danger" style={{fontSize:15}}>{this.state.errors.header6}</div>
               ...
               <div className="row" >
                ...
                <br/>
                <Button tag="a" color="secondary" className='text-white' style={{backgroundColor:"#2ECC71",borderRadius:8,width:160}} wideMobile href="/Customer">
                Next
                  </Button>
